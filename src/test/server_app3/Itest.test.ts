...
describe('Server app integration tests', ()=>{
    ...
    it('should create reservation if authorized', async ()=>{
        const result = await fetch('http://localhost:3001/reservation', {
            method:HTTP_METHODS.POST,
    ...
    it('should get reservation if authorized', async ()=>{
        const result = await fetch(`http://localhost:3001/reservation/${createdReservationId}`, {
    ...
    it('should create and retrieve multiple reservations if authorized', async ()=>{
        ...
        const getAllResult = await fetch(`http://localhost:3001/reservation/all`, {
            method:HTTP_METHODS.GET,
            headers: {
                authorization: token
            }
    ...
    it('should update reservation if authorized', async ()=>{
        const updateResult = await fetch(`http://localhost:3001/reservation/${createdReservationId}`, {
        ...
        const getResult = await fetch(`http://localhost:3001/reservation/${createdReservationId}`, {
            method:HTTP_METHODS.GET,
            headers: {
                authorization: token
            }
    ...
    it('should delete reservation if authorized', async ()=>{
        const deleteResult = await fetch(`http://localhost:3001/reservation/${createdReservationId}`, {
    ...
    it('snapshot demo', async ()=>{
        ...
        const getResult = await fetch(`http://localhost:3001/reservation/12345`, {
            method:HTTP_METHODS.GET,
            headers: {
                authorization: token
            }
